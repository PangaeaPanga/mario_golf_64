...
2. Upload it to the Archipelago website or use the Archipelago Launcher to generate locally.
3. Host or join a multiworld session.

For more information, check out the [Archipelago instructions for generating a game](https://archipelago.gg/tutorial/Archipelago/setup/en#generating-a-game).